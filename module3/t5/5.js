...
for (let i = 0; i < picArray.length; i++) {
  ...
  heading.appendChild(document.createTextNode(picArray[i].title));
  ...
  caption.appendChild(document.createTextNode(picArray[i].caption));
  figure.appendChild(caption);

  article.appendChild(figure);

  let text = document.createElement('p');
  text.appendChild(document.createTextNode(picArray[i].description));
